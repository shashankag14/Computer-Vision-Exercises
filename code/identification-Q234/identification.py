...
for i in (eval_num_bins):
    print("num_bins:", i)
    plt.figure()
    rpc_module.compare_dist_rpc(model_images, query_images, ['chi2', 'intersect', 'l2'], 'rg', i, ['r', 'g', 'b'])
    plt.title('RG histograms')
    plt.show()

    plt.figure()
    rpc_module.compare_dist_rpc(model_images, query_images, ['chi2', 'intersect', 'l2'], 'rgb', int(i / 2), ['r', 'g', 'b'])
    plt.title('RGB histograms')
    plt.show()

    plt.figure()
    rpc_module.compare_dist_rpc(model_images, query_images, ['chi2', 'intersect', 'l2'], 'dxdy', i, ['r', 'g', 'b'])
